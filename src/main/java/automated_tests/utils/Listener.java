...
public class Listener implements ITestListener {
    ...
    public synchronized void onStart(ITestContext context) {
        log.info(String.format(" test case is start."));
    }

    @Override
    public synchronized void onFinish(ITestContext context) {
        log.info(String.format("  test case is finish."));
    }
    ...
    private void getScreenshotAndErrorLogsPages(String testClassName, String testMethodName) throws InterruptedException {
        try {
            ...
            File DestFile = new File("TestErrors\\" + currentDate2 + "\\" + testClassName + "\\" + testMethodName + ".jpg");
            File newFile = new File("TestErrors\\" + currentDate2 + "\\" + testClassName + "\\" + testMethodName + ".txt");
